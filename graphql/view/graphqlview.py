...
class GraphQLView: # pylint: disable = too-many-instance-attributes
    def __init__(
        ...
        self.subscriptions_transport_version = subscriptions_transport_version
        self.subscriptions_fetcher_version = subscriptions_fetcher_version
        self.react_version = react_version
        self.endpoint_url = endpoint_url
        self.subscriptions_protocol = subscriptions_protocol
    ...
    def render_graphiql(self, params, result):
        return render_graphiql(
            ...
            subscriptions_transport_version=self.subscriptions_transport_version,
            subscriptions_fetcher_version=self.subscriptions_fetcher_version,
